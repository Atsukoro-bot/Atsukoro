  ...
  execute: async function (message, args, commands) {
     ...
     */
     ...
     let embed = new MessageEmbed()
       .setAuthor(`${message.author.username} ${sMember == undefined || (sMember?.id == message.author.id) ? " cuddled himself/herself" : "cuddled " + sMember?.username}`, message.author.displayAvatarURL())
       .setImage(res.link)
       .setColor("#5865F2")
       .setTimestamp()
