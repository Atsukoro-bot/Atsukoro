  ...
  execute: async function (message, args) {
     ...
     */
     ...
     let embed = new MessageEmbed()
       .setAuthor(`${message.author.username} ${sMember == undefined || (sMember?.id == message.author.id) ? " fluffed himself/herself" : "fluffed " + sMember?.username}`, message.author.displayAvatarURL())
       .setImage(res.link)
       .setColor("#5865F2")
       .setTimestamp()
